...
<head>
    ...
    <title>Tanda Terima Return {{ $receiptNo }}</title>
    <style>
...
<body>
    ...
    <table class="page-margin-table">
        ...
        <div class="meta-container">
            <div class="meta-card">
                <div class="meta-title">Data Pihak Pengembali</div>
                <table class="meta-table">
                    <tr>
                        <td class="label">Dikembalikan Oleh</td>
                        <td class="val">{{ $returnedBy ?? '-' }}</td>
                    </tr>
                    <tr>
            ...
            <div class="meta-card">
                <div class="meta-title">Data Penerimaan</div>
                <table class="meta-table">
                    <tr>
